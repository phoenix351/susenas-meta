import{a9 as Q,r as m,C as V,aJ as A,aK as X,aL as Y,O as Z,t as P,R as $,p as f,aF as nn,aM as J,av as en,n as F,s as H,aN as on,f as tn,m as z,l as rn}from"./app-02bf3a53.js";function bn(n,e,o,t){return r=>{const[c,a,l]=Q(),{getPrefixCls:C,iconPrefixCls:d,csp:u}=m.useContext(V),s=C(),y={theme:c,token:a,hashId:l,nonce:()=>u==null?void 0:u.nonce};return A(Object.assign(Object.assign({},y),{path:["Shared",s]}),()=>[{"&":X(a)}]),[A(Object.assign(Object.assign({},y),{path:[n,r,d]}),()=>{const{token:g,flush:k}=cn(a),i=Object.assign({},a[n]);if(t!=null&&t.deprecatedTokens){const{deprecatedTokens:I}=t;I.forEach(G=>{let[E,N]=G;var R;(i!=null&&i[E]||i!=null&&i[N])&&((R=i[N])!==null&&R!==void 0||(i[N]=i==null?void 0:i[E]))})}const v=typeof o=="function"?o(K(g,i??{})):o,p=Object.assign(Object.assign({},v),i),x=`.${r}`,b=K(g,{componentCls:x,prefixCls:r,iconCls:`.${d}`,antCls:`.${s}`},p),S=e(b,{hashId:l,prefixCls:r,rootPrefixCls:s,iconPrefixCls:d,overrideComponentToken:i});return k(n,p),[(t==null?void 0:t.resetStyle)===!1?null:Y(a,r),S]}),l]}}const M=typeof CSSINJS_STATISTIC<"u";let O=!0;function K(){for(var n=arguments.length,e=new Array(n),o=0;o<n;o++)e[o]=arguments[o];if(!M)return Object.assign.apply(Object,[{}].concat(e));O=!1;const t={};return e.forEach(r=>{Object.keys(r).forEach(a=>{Object.defineProperty(t,a,{configurable:!0,enumerable:!0,get:()=>r[a]})})}),O=!0,t}function an(){}function cn(n){let e,o=n,t=an;return M&&(e=new Set,o=new Proxy(n,{get(r,c){return O&&e.add(c),r[c]}}),t=(r,c)=>{Array.from(e)}),{token:o,keys:e,flush:t}}function U(n){var e;return n==null||(e=n.getRootNode)===null||e===void 0?void 0:e.call(n)}function sn(n){return U(n)!==(n==null?void 0:n.ownerDocument)}function ln(n){return sn(n)?U(n):null}function un(n){return n.replace(/-(.)/g,function(e,o){return o.toUpperCase()})}function dn(n,e){Z(n,"[@ant-design/icons] ".concat(e))}function L(n){return P(n)==="object"&&typeof n.name=="string"&&typeof n.theme=="string"&&(P(n.icon)==="object"||typeof n.icon=="function")}function B(){var n=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};return Object.keys(n).reduce(function(e,o){var t=n[o];switch(o){case"class":e.className=t,delete e.class;break;default:delete e[o],e[un(o)]=t}return e},{})}function _(n,e,o){return o?$.createElement(n.tag,f(f({key:e},B(n.attrs)),o),(n.children||[]).map(function(t,r){return _(t,"".concat(e,"-").concat(n.tag,"-").concat(r))})):$.createElement(n.tag,f({key:e},B(n.attrs)),(n.children||[]).map(function(t,r){return _(t,"".concat(e,"-").concat(n.tag,"-").concat(r))}))}function W(n){return nn(n)[0]}function q(n){return n?Array.isArray(n)?n:[n]:[]}var mn=`
.anticon {

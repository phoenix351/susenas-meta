...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('vsusenas_mak', function (Blueprint $table) {
            ...
            $table->integer('hal10_jml_komoditas')->nullable();
            $table->integer('hal8_jml_komoditas')->nullable();
            $table->integer('hal6_jml_komoditas')->nullable();
            $table->integer('hal4_jml_komoditas')->nullable();
            $table->integer('hal2_jml_komoditas')->nullable();
        });
    }
